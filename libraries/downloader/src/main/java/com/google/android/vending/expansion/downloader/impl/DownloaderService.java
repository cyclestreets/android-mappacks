...
public abstract class DownloaderService extends 
    ...
    private void updateNetworkState(NetworkInfo info) {
        ...
        boolean isAtLeast4G = mIsAtLeast4G;
        if (null != info) {
        ...
        if (Constants.LOGVV) {
            if (mStateChanged) {
                ...
                Log.v(LOG_TAG, "Starting State: " +
                        ...
                        (isAtLeast3G ? (isAtLeast4G ? "4G " : "3G+ ") : "<3G "));
    ...
    private APKExpansionPolicy getExpansionPolicy(final Context context) {
      ...
      final APKExpansionPolicy aep = new APKExpansionPolicy(context,
                  new AESObfuscator(getSALT(), context.getPackageName(), deviceId));
          ...
          public void allow(int reason) {
            try {
              ...
              try {
                ...
                switch (startDownloadServiceIfRequired(mContext, mPendingIntent, serviceClass)) {
                    ...
                    case DOWNLOAD_REQUIRED:
                      // do nothing. the download will notify the application
                      // when things are done break;
                }
    ...
    protected void onHandleIntent(Intent intent) 
    {
      ...
      try {
        ...
        // and download status when the instance is created
        DownloadsDB db = DownloadsDB.getDB(this);
        final PendingIntent pendingIntent = (PendingIntent)intent.getParcelableExtra(EXTRA_PENDING_INTENT);
    ...
    public void onCreate() {
        ...
        try {
            ...
            mNotification = createDownloadNotification(this, applicationLabel);
    ...
    {
      return new DownloadNotification(context, label);
